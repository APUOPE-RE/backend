...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * Get the implicit to-many join path to the <code>apuope.quiz</code> table
     */
    public QuizPath quiz() {
        if (_quiz == null)
            _quiz = new QuizPath(this, null, Keys.QUIZ__FK_ACCOUNT.getInverseKey());
    ...
    public QuizResultPath quizResult() {
        if (_quizResult == null)
            _quizResult = new QuizResultPath(this, null, Keys.QUIZ_RESULT__FK_ACCOUNT.getInverseKey());
